...
function Events() {
    ...
    async function listAll() {
        ...
        dispatch({ type: "ADD_EVENTS", event: response.data });
    }
    ...
    function remove(e, event) {
        ...
        api.delete(`/events/${event.id}`).then(() => {
            listAll();
        });
    }
                    ...
                    {eventList.map(event =>
                        event.topic
                            ...
                            <tr key={event.id}>
                                ...
                                <td>
                                    {event.batches && event.batches.length
                                        ? event.batches[
                                              event.batches.length - 1
                                          ].name
                                        : "Not found"}
                                </td>
                                <td>Not found</td>
                    ...
                    <div className="modal-content">
                        <div className="modal-header">
                            <h4 className="modal-title " id="modalDeleteLabel">
                                Delete {action === null ? "" : action.topic}{" "}
                                event{" "}
                            </h4>
                            <button
                                type="button"
